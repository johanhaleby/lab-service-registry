...
public class MessageSender {
    ...
    private static final String ANONYMOUS_ROUTING_KEY = "lab.anonymous.info";

    private static final Map<String, String> EVENT_TYPE_TO_ROUTING_KEY = new HashMap<String, String>() {{
        put(GAME_CREATED_EVENT, "lab.game.created");
        put(GAME_ENDED_EVENT, "lab.game.ended");
        put(LOG_EVENT, "lab.log.debug");
        put(SERVICE_ONLINE_EVENT, "lab.service.online");
        put(SERVICE_OFFLINE_EVENT, "lab.service.offline");
    }};
